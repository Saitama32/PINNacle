...
if __name__ == "__main__":
    ...
    for pde_config in pde_list:
        ...
        def get_model_dde():
            ...
            loss_weights_cli = parse_loss_weight(command_args)

            if loss_weights_cli is not None:
                loss_weights = np.array(loss_weights_cli, dtype=float)
            else:
        ...
        trainer.add_task(
            get_model_dde, {
                ...
                "callbacks": [
                    ...
                    ModelSaverCallback(total_iterations=command_args.iter, n_save_models=10)
                ]
            }
        )
