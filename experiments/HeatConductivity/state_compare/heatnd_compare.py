...
experiment = start(
    api_key=api_key,
    project_name=f"rlpinn_heatnd_{_state_type_for_comet}_comparison",
    workspace="saitama32",
)
...
def main(seed_override=None):
    ...
    parser.add_argument("--name", type=str, default="heatnd_rl")
    ...
    experiment.log_parameters({
        "param": "v_1",
        "reward_function": "v_2",
        "description": "comparison_heatnd_loaded_dqn_final_eval",
    ...
    pde_kwargs = {"dim": args.dim, "T": args.time_horizon}
