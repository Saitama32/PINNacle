...
experiment = start(
    api_key=api_key,
    project_name="rlpinn_heat2d_multiscale_rebuild_buffer_1_dim",
    workspace="saitama32",
)
...
def main():
    ...
    experiment.log_parameters({
        ...
        "reward_function": "v_2",
        "description": (
            "rebuild_heat2d_multiscale_buffer"
            if args.rebuild_buffer_only
            else "optimization_heat2d_multiscale_rl_optimizer"
        ),
        "rebuild_buffer_only": args.rebuild_buffer_only,
        "source_project_name": DEFAULT_SOURCE_PROJECT_NAME,
