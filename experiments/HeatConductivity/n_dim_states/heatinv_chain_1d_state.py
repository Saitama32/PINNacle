...
TARGET_PROJECT_NAME = "rlpinn_heatinv_rebuild_buffer_1_dim"
DEFAULT_SOURCE_PROJECT_NAME = "rlpinn-heatinv-loss-chain-tolerance"
LOCAL_OUTPUT_DIR = os.path.join("transitions_rebuilt", "heatinv_1_dim")
...
def main():
    ...
    parser.add_argument("--name", type=str, default="heatinv_1d_state_rebuild")
    ...
    experiment.log_parameters({
        ...
        "reward_function": "v_2",
        "description": (
            "rebuild_heatinv_buffer_1d_state"
            if args.rebuild_buffer_only
            else "optimization_heatinv_rl_optimizer_1d_state"
        ),
