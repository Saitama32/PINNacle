...
TARGET_PROJECT_NAME = "rlpinn_heatnd_rebuild_buffer_3_dim"
DEFAULT_SOURCE_PROJECT_NAME = "rlpinn-heatnd-loss-chain-tolerance"
path_to_trans = os.path.join("transitions_rebuilt", "heatnd")
...
def main():
    ...
    parser.add_argument("--name", type=str, default="heatnd_rebuild")
    ...
    experiment.log_parameters({
        ...
        "reward_function": "v_2",
        "description": (
            "rebuild_heatnd_buffer"
            if args.rebuild_buffer_only
            else "optimization_heatnd_rl_optimizer"
        ),
