#!/bin/bash
# Rebuild buffers from two source experiments and distribute jobs across GPUs.

SCRIPT="experiments/HeatConductivity/n_dim_states/heat2d_multiscale_chain.py"
