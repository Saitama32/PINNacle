...
TARGET_PROJECT_NAME = "rlpinn_heatinv_rebuild_buffer_3_dim"
DEFAULT_SOURCE_PROJECT_NAME = "rlpinn-heatinv-loss-chain-tolerance"
path_to_trans = os.path.join("transitions_rebuilt", "heatinv")
...
def main():
    ...
    parser.add_argument("--name", type=str, default="heatinv_rebuild")
    ...
    experiment.log_parameters({
        ...
        "reward_function": "v_2",
        "description": (
            "rebuild_heatinv_buffer"
            if args.rebuild_buffer_only
            else "optimization_heatinv_rl_optimizer"
        ),
