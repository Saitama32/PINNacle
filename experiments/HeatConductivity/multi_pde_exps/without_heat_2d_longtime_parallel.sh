#!/bin/bash
# Auto-run multi-PDE RL training and distribute jobs across available GPUs.

SCRIPT="experiments/HeatConductivity/multi_pde_exps/without_heat_2d_longtime_train.py"
