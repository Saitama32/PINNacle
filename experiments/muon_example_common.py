...
def add_muon_example_args(parser):
    parser.add_argument("--name", type=str, default="muon_example")
...
def run_muon_example(pde_cls, args, pde_kwargs=None):
