...
experiment = start(
    api_key=api_key,
    project_name=f"rlpinn_ns2d_liddriven_agent_ablation_{args.ablation}",
    workspace="saitama32",
)
...
def main():
    ...
    parser.add_argument("--ablation", choices=tuple(ABLATION_FLAGS), default="full")

    args = parser.parse_args()
    ablation_flags = ABLATION_FLAGS[args.ablation]
