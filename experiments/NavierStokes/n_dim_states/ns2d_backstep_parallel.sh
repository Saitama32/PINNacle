#!/bin/bash
# Rebuild NS2D BackStep buffers from two source experiments and distribute jobs across GPUs.

SCRIPT="experiments/NavierStokes/n_dim_states/ns2d_backstep_chain.py"
