...
TARGET_PROJECT_NAME = "rlpinn_ns2d_liddriven_rebuild_buffer_3_dim"
DEFAULT_SOURCE_PROJECT_NAME = "rlpinn-ns2d-liddriven-tolerance"
path_to_trans = os.path.join("transitions_rebuilt", "ns2d_liddriven")
...
def main():
    ...
    parser.add_argument("--name", type=str, default="ns2d_liddriven_rebuild")
    ...
    experiment.log_parameters({
        ...
        "reward_function": "v_2",
        "description": (
            "rebuild_ns2d_liddriven_buffer"
            if args.rebuild_buffer_only
            else "optimization_ns2d_liddriven_rl_optimizer"
        ),
