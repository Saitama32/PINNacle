#!/bin/bash
# Rebuild NS2D LidDriven buffers from two source experiments and distribute jobs across GPUs.

SCRIPT="experiments/NavierStokes/n_dim_states/ns2d_liddriven_chain.py"
