...
experiment = start(
    api_key=api_key,
    project_name="rlpinn-ns2d-backstep-optimization-raw-loss-log-improve-nn",
    workspace="saitama32",
)
...
experiment.log_parameters({
    "param": "v_1",
    "reward_function": "v_2",
    "description": "optimization_ns2d_backstep_raw_log_loss_state",
})
...
def main():
    ...
    parser.add_argument("--name", type=str, default="ns2d_backstep_rl")
    ...
    pde_kwargs = {"datapath": args.datapath, "nu": args.nu}
    ...
    rl_agent_params = {
        ...
        "exp": experiment,
        "log_key": True,
        "proj_name": "rlpinn-ns2d-backstep-rebuild-buffer-raw-loss-no-log",
