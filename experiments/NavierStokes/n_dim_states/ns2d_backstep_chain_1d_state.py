...
from src.pde.ns import NS2D_BackStep
...
TARGET_PROJECT_NAME = "rlpinn_ns2d_backstep_rebuild_buffer_1_dim"
DEFAULT_SOURCE_PROJECT_NAME = "rlpinn-ns2d-backstep-loss-chain-tolerance"
LOCAL_OUTPUT_DIR = os.path.join("transitions_rebuilt", "ns2d_backstep_1_dim")


def build_get_model_ns2d_backstep(hidden_layers: str, **pde_kwargs):
    def get_model():
        pde = NS2D_BackStep(**pde_kwargs)
...
def main():
    ...
    parser.add_argument("--name", type=str, default="ns2d_backstep_1d_state_rebuild")
    ...
    experiment.log_parameters({
        ...
        "reward_function": "v_2",
        "description": (
            "rebuild_ns2d_backstep_buffer_1d_state"
            if args.rebuild_buffer_only
            else "optimization_ns2d_backstep_rl_optimizer_1d_state"
        ),
    ...
    get_model_rec = build_get_model_ns2d_backstep(args.hidden_layers, **pde_kwargs)
