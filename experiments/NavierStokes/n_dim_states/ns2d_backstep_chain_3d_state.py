...
experiment = start(
    api_key=api_key,
    project_name="rlpinn_ns2d_backstep_optimization_3_dim_improve_nn",
    workspace="saitama32",
)
...
experiment.log_parameters({
    "param": "v_1",
    "reward_function": "v_2",
    "description": "optimization_ns2d_backstep_3d_state",
})
...
def main():
    ...
    rl_agent_params = {
        ...
        "exp": experiment,
        "log_key": False,
        "proj_name": "rlpinn-ns2d-backstep-rebuild-buffer-3-dim",
