...
experiment = start(
  ...
  project_name="rlpinn_ns2d_liddriven_optimization_1_dim_improve_nn",
  workspace="saitama32"
)
...
experiment.log_parameters({
    "param": "v_1",
    "reward_function": "v_2",
    "description": "optimization_ns2d_liddriven_1d_state"
})
...
def main():
    ...
    rl_agent_params = {
        ...
        "exp": experiment,
        "log_key": False,
        "proj_name": "rlpinn-ns2d-liddriven-rebuild-buffer-1-dim"
    }
