...
TARGET_PROJECT_NAME = "rlpinn_ns2d_liddriven_rebuild_buffer_1_dim"
DEFAULT_SOURCE_PROJECT_NAME = "rlpinn-ns2d-liddriven-tolerance"
LOCAL_OUTPUT_DIR = os.path.join("transitions_rebuilt", "ns2d_liddriven_1_dim")
...
def main():
    ...
    parser.add_argument("--name", type=str, default="NS2D_LidDriven_1d_state_rebuild")
    ...
    experiment.log_parameters({
        ...
        "reward_function": "v_2",
        "description": (
            "rebuild_ns2d_liddriven_buffer_1d_state"
            if args.rebuild_buffer_only
            else "optimization_ns2d_liddriven_rl_optimizer_1d_state"
        ),
