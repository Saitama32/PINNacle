...
experiment = start(
    ...
    project_name="rlpinn_ns2d_longtime_comparison",
    workspace="saitama32",
)
...
experiment.log_parameters({
    "param": "v_1",
    "reward_function": "v_2",
    "description": "comparison_ns2d_longtime_rl_optimizer",
})
...
if __name__ == "__main__":
    ...
    # seeds = [456, 567]   # можно расширить список
    # seeds = [678, 789]   # можно расширить список
    seeds = [890, 901]
