...
experiment = start(
    ...
    project_name="rlpinn-heat-pde-agent-without-heat2d-longtime-comapre",
    workspace="saitama32",
)
...
experiment.log_parameters({
    "param": "v_1",
    "reward_function": "v_2",
    "description": "comparison_heat2d_longtime_rl_optimizer",
})
...
def build_get_model_heat2d_longtime(hidden_layers: str, **pde_kwargs):
    def get_model():
        pde = Heat2D_LongTime(**pde_kwargs)
...
def main(seed_override=None):
    ...
    parser.add_argument("--name", type=str, default="heat2d_longtime_rl")
...
# RL config
    ...
    get_model_rec = build_get_model_heat2d_longtime(args.hidden_layers, **pde_kwargs)
...
if __name__ == "__main__":
    ...
    seeds = [123, 234, 345, 456]   # можно расширить список
