...
experiment = start(
    api_key=api_key,
    project_name=f"rlpinn_poisson2d_manyarea_{_state_type_for_comet}_comparison",
    workspace="saitama32",
)
...
def main(seed_override=None):
    ...
    parser.add_argument("--state-type", type=str, choices=STATE_TYPE_CHOICES, required=True)
    ...
    experiment.log_parameters({
        "param": "v_1",
        "reward_function": "v_2",
        "description": "comparison_poisson2d_manyarea_loaded_dqn_final_eval",
