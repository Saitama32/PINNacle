...
experiment = start(
    api_key=api_key,
    project_name="rlpinn_poisson2d_classic_tolerance",
    workspace="saitama32",
)
...
experiment.log_parameters({
    "param": "v_1",
    "reward_function": "v_2",
    "description": "tolerance_poisson2d_classic_rl_optimizer",
})
...
def main():
    ...
    parser.add_argument("--scale", type=float, default=1.0, help="Geometry scale")
