...
experiment = start_comet_experiment(
    project_name="rlpinn_poisson2d_classic_loss_chain_tolerance",
)
...
experiment.log_parameters({
    "param": "v_1",
    "reward_function": "v_2",
    "description": "optimization_poisson2d_classic_rl_optimizer",
})


def build_get_model_poisson2d_classic(hidden_layers: str, **pde_kwargs):
    def get_model():
        pde = Poisson2D_Classic(**pde_kwargs)
...
def main():
    ...
    parser.add_argument("--datapath", type=str, default="ref/poisson1_cg_data.dat", help="Reference data path")
    parser.add_argument("--scale", type=float, default=1.0, help="Domain scale")
    ...
    get_model = build_get_model_poisson2d_classic(args.hidden_layers, **pde_kwargs)
    get_model_rec = build_get_model_poisson2d_classic(args.hidden_layers, **pde_kwargs)
