...
_pre_parser.add_argument("--ablation", choices=ABLATION_CHOICES, required=True)
_pre_parser.add_argument("--seeds", type=parse_seeds, required=True)
_pre_args, _ = _pre_parser.parse_known_args()
_ablation_for_comet = _pre_args.ablation
_seeds_for_run = _pre_args.seeds

experiment = start(
    api_key=api_key,
    project_name=f"rlpinn_poisson3d_complexgeometry_agent_ablation_{_ablation_for_comet}_comparison",
    workspace="saitama32",
)
