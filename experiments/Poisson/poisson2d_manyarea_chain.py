...
experiment = start_comet_experiment(
    project_name="rlpinn_poisson2d_manyarea_loss_chain_tolerance",
)
...
experiment.log_parameters({
    "param": "v_1",
    "reward_function": "v_2",
    "description": "optimization_poisson2d_manyarea_rl_optimizer",
})


def build_get_model_poisson2d_manyarea(hidden_layers: str, **pde_kwargs):
    def get_model():
        pde = Poisson2D_ManyArea(**pde_kwargs)
...
def main():
    ...
    parser.add_argument("--name", type=str, default="poisson2d_manyarea_rl")
    ...
    parser.add_argument("--datapath", type=str, default="ref/poisson_manyarea.dat", help="Reference data path")
    parser.add_argument("--freq", type=int, default=2, help="Source frequency count")
    ...
    get_model = build_get_model_poisson2d_manyarea(args.hidden_layers, **pde_kwargs)
    get_model_rec = build_get_model_poisson2d_manyarea(args.hidden_layers, **pde_kwargs)
