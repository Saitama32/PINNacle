...
experiment = start(
    api_key=api_key,
    project_name="rlpinn_poisson2d_manyarea_tolerance",
    workspace="saitama32",
)
...
experiment.log_parameters({
    "param": "v_1",
    "reward_function": "v_2",
    "description": "tolerance_poisson2d_manyarea_rl_optimizer",
})
...
def main():
    ...
    parser.add_argument("--freq", type=int, default=2, help="Coefficient frequency per subdomain")
