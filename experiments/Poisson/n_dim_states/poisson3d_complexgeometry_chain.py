...
TARGET_PROJECT_NAME = "rlpinn_poisson3d_complexgeometry_rebuild_buffer_3_dim"
DEFAULT_SOURCE_PROJECT_NAME = "rlpinn-poisson3d-complexgeometry-tolerance"
path_to_trans = os.path.join("transitions_rebuilt", "poisson3d_complexgeometry")
...
def main():
    ...
    parser.add_argument("--name", type=str, default="poisson3d_complexgeometry_rebuild")
    ...
    experiment.log_parameters({
        ...
        "reward_function": "v_2",
        "description": (
            "rebuild_poisson3d_complexgeometry_buffer"
            if args.rebuild_buffer_only
            else "optimization_poisson3d_complexgeometry_rl_optimizer"
        ),
