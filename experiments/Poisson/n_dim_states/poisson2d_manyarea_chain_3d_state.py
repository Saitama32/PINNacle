...
experiment = start(
    api_key=api_key,
    project_name="rlpinn_poisson2d_manyarea_optimization_3_dim_improve_nn",
    workspace="saitama32",
)
...
experiment.log_parameters({
    "param": "v_1",
    "reward_function": "v_2",
    "description": "optimization_poisson2d_manyarea_3d_state",
})
...
def main():
    ...
    rl_agent_params = {
        ...
        "exp": experiment,
        "log_key": False,
        "proj_name": "rlpinn-poisson2d-manyarea-rebuild-buffer-3-dim",
