...
experiment = start(
    api_key=api_key,
    project_name="rlpinn_poisson3d_complexgeometry_optimization_3_dim_improve_nn",
    workspace="saitama32",
)
...
experiment.log_parameters({
    "param": "v_1",
    "reward_function": "v_2",
    "description": "optimization_poisson3d_complexgeometry_3d_state",
})
...
def main():
    ...
    rl_agent_params = {
        ...
        "exp": experiment,
        "log_key": False,
        "proj_name": "rlpinn-poisson3d-complexgeometry-rebuild-buffer-3-dim",
