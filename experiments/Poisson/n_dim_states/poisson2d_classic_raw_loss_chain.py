...
TARGET_PROJECT_NAME = "rlpinn_poisson2d_classic_rebuild_buffer_raw_loss_no_log"
LOCAL_OUTPUT_DIR = os.path.join("transitions_rebuilt", "poisson2d_classic_raw_loss")
...
def main():
    ...
    parser.add_argument("--name", type=str, default="poisson2d_classic_raw_loss_rebuild")
    ...
    experiment.log_parameters({
        "param": "raw_loss_v1",
        "description": "rebuild_poisson2d_classic_buffer_raw_loss_without_autoencoder",
