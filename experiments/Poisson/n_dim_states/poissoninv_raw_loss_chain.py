...
TARGET_PROJECT_NAME = "rlpinn_poissoninv_rebuild_buffer_raw_loss_no_log"
LOCAL_OUTPUT_DIR = os.path.join("transitions_rebuilt", "poissoninv_raw_loss")
...
def main():
    ...
    parser.add_argument("--name", type=str, default="poissoninv_raw_loss_rebuild")
    ...
    experiment.log_parameters({
        "param": "raw_loss_v1",
        "description": "rebuild_poissoninv_buffer_raw_loss_without_autoencoder",
