...
experiment = start(
    api_key=api_key,
    project_name="rlpinn-poissonnd-optimization-raw-log-loss-improve-nn",
    workspace="saitama32",
)
...
experiment.log_parameters({
    "param": "v_1",
    "reward_function": "v_2",
    "description": "optimization_poissonnd_raw_log_loss_state",
})
...
def main():
    ...
    rl_agent_params = {
        ...
        "exp": experiment,
        "log_key": True,
        "proj_name": "rlpinn-poissonnd-rebuild-buffer-raw-loss-no-log",
