...
experiment = start(
    api_key=api_key,
    project_name="rlpinn-poisson2d-classic-optimization-raw-loss-log-improve-nn",
    workspace="saitama32",
)
...
experiment.log_parameters({
    "param": "v_1",
    "reward_function": "v_2",
    "description": "optimization_poisson2d_classic_raw_log_loss_state",
})
...
def main():
    ...
    rl_agent_params = {
        ...
        "exp": experiment,
        "log_key": True,
        "proj_name": "rlpinn-poisson2d-classic-rebuild-buffer-raw-loss-no-log",
