...
TARGET_PROJECT_NAME = "rlpinn_poissonnd_rebuild_buffer_3_dim"
DEFAULT_SOURCE_PROJECT_NAME = "rlpinn-poissonnd-tolerance"
path_to_trans = os.path.join("transitions_rebuilt", "poisson_nd")
...
def main():
    ...
    parser.add_argument("--name", type=str, default="poissonnd_rebuild")
    ...
    experiment.log_parameters({
        ...
        "reward_function": "v_2",
        "description": (
            "rebuild_poissonnd_buffer"
            if args.rebuild_buffer_only
            else "optimization_poissonnd_rl_optimizer"
        ),
