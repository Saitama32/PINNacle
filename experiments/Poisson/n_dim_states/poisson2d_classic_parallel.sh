#!/bin/bash
# Rebuild Poisson2D Classic buffers from two source experiments and distribute jobs across GPUs.

SCRIPT="experiments/Poisson/n_dim_states/poisson2d_classic_chain.py"
