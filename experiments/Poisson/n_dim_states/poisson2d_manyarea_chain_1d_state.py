...
from src.pde.poisson import Poisson2D_ManyArea
...
TARGET_PROJECT_NAME = "rlpinn_poisson2d_manyarea_rebuild_buffer_1_dim"
DEFAULT_SOURCE_PROJECT_NAME = "rlpinn-poisson2d-manyarea-loss-chain-tolerance"
LOCAL_OUTPUT_DIR = os.path.join("transitions_rebuilt", "poisson2d_manyarea_1_dim")


def build_get_model_poisson2d_manyarea(hidden_layers: str):
    def get_model():
        pde = Poisson2D_ManyArea()
...
def main():
    ...
    parser.add_argument("--name", type=str, default="poisson2d_manyarea_1d_state_rebuild")
    ...
    experiment.log_parameters({
        ...
        "reward_function": "v_2",
        "description": (
            "rebuild_poisson2d_manyarea_buffer_1d_state"
            if args.rebuild_buffer_only
            else "optimization_poisson2d_manyarea_rl_optimizer_1d_state"
        ),
    ...
    get_model = build_get_model_poisson2d_manyarea(args.hidden_layers)
    get_model_rec = build_get_model_poisson2d_manyarea(args.hidden_layers)
