...
TARGET_PROJECT_NAME = "rlpinn_poissoninv_rebuild_buffer_3_dim"
DEFAULT_SOURCE_PROJECT_NAME = "rlpinn-poissoninv-loss-chain-tolerance"
path_to_trans = os.path.join("transitions_rebuilt", "poissoninv")
...
def main():
    ...
    parser.add_argument("--name", type=str, default="poissoninv_rebuild")
    ...
    experiment.log_parameters({
        ...
        "reward_function": "v_2",
        "description": (
            "rebuild_poissoninv_buffer"
            if args.rebuild_buffer_only
            else "optimization_poissoninv_rl_optimizer"
        ),
