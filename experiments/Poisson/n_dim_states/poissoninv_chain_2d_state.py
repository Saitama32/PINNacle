...
experiment = start(
    api_key=api_key,
    project_name="rlpinn_poissoninv_optimization_2_dim_improve_nn",
    workspace="saitama32",
)
...
experiment.log_parameters({
    "param": "v_1",
    "reward_function": "v_2",
    "description": "optimization_poissoninv_2d_state",
})
...
def main():
    ...
    rl_agent_params = {
        ...
        "exp": experiment,
        "log_key": False,
        "proj_name": "rlpinn-poissoninv-loss-chain-tolerance",
