...
TARGET_PROJECT_NAME = "rlpinn_poisson_boltzmann2d_rebuild_buffer_3_dim"
DEFAULT_SOURCE_PROJECT_NAME = "rlpinn-poisson-boltzmann2d-loss-chain-tolerance"
path_to_trans = os.path.join("transitions_rebuilt", "poisson_boltzmann2d")
...
def main():
    ...
    parser.add_argument("--name", type=str, default="poisson_boltzmann2d_rebuild")
    ...
    experiment.log_parameters({
        ...
        "reward_function": "v_2",
        "description": (
            "rebuild_poisson_boltzmann2d_buffer"
            if args.rebuild_buffer_only
            else "optimization_poisson_boltzmann2d_rl_optimizer"
        ),
