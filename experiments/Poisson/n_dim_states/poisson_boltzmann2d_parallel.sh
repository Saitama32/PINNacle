#!/bin/bash
# Rebuild PoissonBoltzmann2D buffers from two source experiments and distribute jobs across GPUs.

SCRIPT="experiments/Poisson/n_dim_states/poisson_boltzmann2d_chain.py"
