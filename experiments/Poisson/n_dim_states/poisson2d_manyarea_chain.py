...
TARGET_PROJECT_NAME = "rlpinn_poisson2d_manyarea_rebuild_buffer_3_dim"
DEFAULT_SOURCE_PROJECT_NAME = "rlpinn-poisson2d-manyarea-loss-chain-tolerance"
path_to_trans = os.path.join("transitions_rebuilt", "poisson2d_manyarea")
...
def main():
    ...
    parser.add_argument("--name", type=str, default="poisson2d_manyarea_rebuild")
    ...
    experiment.log_parameters({
        ...
        "reward_function": "v_2",
        "description": (
            "rebuild_poisson2d_manyarea_buffer"
            if args.rebuild_buffer_only
            else "optimization_poisson2d_manyarea_rl_optimizer"
        ),
