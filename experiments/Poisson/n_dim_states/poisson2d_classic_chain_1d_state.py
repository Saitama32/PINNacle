...
TARGET_PROJECT_NAME = "rlpinn_poisson2d_classic_rebuild_buffer_1_dim"
DEFAULT_SOURCE_PROJECT_NAME = "rlpinn-poisson2d-classic-loss-chain-tolerance"
LOCAL_OUTPUT_DIR = os.path.join("transitions_rebuilt", "poisson2d_classic_1_dim")
...
def main():
    ...
    parser.add_argument("--name", type=str, default="poisson2d_classic_1d_state_rebuild")
    ...
    experiment.log_parameters({
        ...
        "reward_function": "v_2",
        "description": (
            "rebuild_poisson2d_classic_buffer_1d_state"
            if args.rebuild_buffer_only
            else "optimization_poisson2d_classic_rl_optimizer_1d_state"
        ),
