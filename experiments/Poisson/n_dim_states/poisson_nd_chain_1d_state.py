...
TARGET_PROJECT_NAME = "rlpinn_poissonnd_rebuild_buffer_1_dim"
DEFAULT_SOURCE_PROJECT_NAME = "rlpinn-poissonnd-tolerance"
LOCAL_OUTPUT_DIR = os.path.join("transitions_rebuilt", "poisson_nd_1_dim")
...
def main():
    ...
    parser.add_argument("--name", type=str, default="poissonnd_1d_state_rebuild")
    ...
    experiment.log_parameters({
        ...
        "reward_function": "v_2",
        "description": (
            "rebuild_poissonnd_buffer_1d_state"
            if args.rebuild_buffer_only
            else "optimization_poissonnd_rl_optimizer_1d_state"
        ),
    ...
    pde_kwargs = dict(dim=args.dim, len=args.length)
