...
TARGET_PROJECT_NAME = "rlpinn_poisson_boltzmann2d_rebuild_buffer_1_dim"
DEFAULT_SOURCE_PROJECT_NAME = "rlpinn-poisson-boltzmann2d-loss-chain-tolerance"
LOCAL_OUTPUT_DIR = os.path.join("transitions_rebuilt", "poisson_boltzmann2d_1_dim")
...
def main():
    ...
    parser.add_argument("--name", type=str, default="poisson_boltzmann2d_1d_state_rebuild")
    ...
    experiment.log_parameters({
        ...
        "reward_function": "v_2",
        "description": (
            "rebuild_poisson_boltzmann2d_buffer_1d_state"
            if args.rebuild_buffer_only
            else "optimization_poisson_boltzmann2d_rl_optimizer_1d_state"
        ),
