...
experiment = start(
    api_key=api_key,
    project_name="rlpinn_poisson_boltzmann2d_optimization_1_dim_improve_nn",
    workspace="saitama32",
)
...
experiment.log_parameters({
    "param": "v_1",
    "reward_function": "v_2",
    "description": "optimization_poisson_boltzmann2d_1d_state",
})
...
def main():
    ...
    rl_agent_params = {
        ...
        "exp": experiment,
        "log_key": False,
        "proj_name": "rlpinn-poisson-boltzmann2d-rebuild-buffer-1-dim",
