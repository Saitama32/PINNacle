"""Train Wave2D_Heterogeneous (CG benchmark) with the weak-form objective."""
...
def make_parser():
    ...
    parser.add_argument("--name", default="wave2d_heterogeneous_weak")
    parser.add_argument(
        "--device",
    ...
    parser.add_argument("--spatial-cells-x", type=int, default=4)
    parser.add_argument("--spatial-cells-y", type=int, default=4)
    parser.add_argument("--quadrature-order", type=int, default=6)
    parser.add_argument("--test-function-count", type=int, default=4)
    parser.add_argument("--time-samples", type=int, default=8)
    ...
    parser.add_argument("--datapath", default="ref/wave_darcy.dat")
    return parser
...
def main():
    ...
    pde = Wave2D_Heterogeneous(datapath=args.datapath)
    ...
    weak_config = WeakFormConfig(
        spatial_cells=(args.spatial_cells_x, args.spatial_cells_y),
