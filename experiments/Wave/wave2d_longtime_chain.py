...
experiment = start(
    ...
    project_name="rlpinn_wave2d_longtime_optimization",
    workspace="saitama32",
)
import sys
...
experiment.log_parameters({
    "param": "v_1",
    "reward_function": "v_2",
    "description": "optimization_wave2d_longtime_rl_optimizer",
})


def build_get_model_wave2d_longtime(hidden_layers: str, **pde_kwargs):
    def get_model():
        pde = Wave2D_LongTime(**pde_kwargs)
...
def main():
    ...
    parser.add_argument("--name", type=str, default="wave2d_longtime_rl")
    ...
    get_model_rec = build_get_model_wave2d_longtime(args.hidden_layers, **pde_kwargs)
