...
TARGET_PROJECT_NAME = "rlpinn_wave1d_rebuild_buffer_3_dim"
DEFAULT_SOURCE_PROJECT_NAME = "rlpinn-wave1d-tolerance"
path_to_trans = os.path.join("transitions_rebuilt", "wave1d")
...
def main():
    ...
    parser.add_argument("--name", type=str, default="wave1d_rebuild")
    ...
    experiment.log_parameters({
        ...
        "reward_function": "v_2",
        "description": (
            "rebuild_wave1d_buffer"
            if args.rebuild_buffer_only
            else "optimization_wave1d_rl_optimizer"
        ),
