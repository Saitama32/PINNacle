...
TARGET_PROJECT_NAME = "rlpinn_wave1d_rebuild_buffer_1_dim"
DEFAULT_SOURCE_PROJECT_NAME = "rlpinn-wave1d-tolerance"
LOCAL_OUTPUT_DIR = os.path.join("transitions_rebuilt", "wave1d_1_dim")
...
def main():
    ...
    parser.add_argument("--name", type=str, default="wave1d_1d_state_rebuild")
    ...
    experiment.log_parameters({
        ...
        "reward_function": "v_2",
        "description": (
            "rebuild_wave1d_buffer_1d_state"
            if args.rebuild_buffer_only
            else "optimization_wave1d_rl_optimizer_1d_state"
        ),
    ...
    pde_kwargs = dict(C=args.C, scale=args.scale, a=args.a)
