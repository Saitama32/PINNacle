...
experiment = start(
    api_key=api_key,
    project_name="rlpinn_wave2d_heterogeneous_comparison",
    workspace="saitama32",
)
...
experiment.log_parameters({
    "param": "v_1",
    "reward_function": "v_2",
    "description": "comparison_wave2d_heterogeneous_rl_optimizer",
})
...
def build_get_model_wave2d_heterogeneous(hidden_layers: str, **pde_kwargs):
    def get_model():
        pde = Wave2D_Heterogeneous(**pde_kwargs)
...
def main(seed_override=None):
    ...
    parser.add_argument("--name", type=str, default="wave2d_heterogeneous_rl")
    ...
    get_model = build_get_model_wave2d_heterogeneous(args.hidden_layers, **pde_kwargs)
    get_model_rec = build_get_model_wave2d_heterogeneous(args.hidden_layers, **pde_kwargs)
...
if __name__ == "__main__":
    ...
    seeds = [456, 567, 678]   # можно расширить список
