...
experiment = start(
    ...
    project_name="rlpinn_burgers2d_comparison",
    workspace="saitama32",
)
...
experiment.log_parameters({
    "param": "v_1",
    "reward_function": "v_2",
    "description": "comparison_burgers2d_rl_optimizer",
})
...
def build_get_model_burgers2d(hidden_layers: str, **pde_kwargs):
    def get_model():
        pde = Burgers2D(**pde_kwargs)
...
def main(seed_override=None):
    ...
    parser.add_argument("--name", type=str, default="burgers2d_rl")
    ...
    get_model_rec = build_get_model_burgers2d(args.hidden_layers, **pde_kwargs)
...
if __name__ == "__main__":
    ...
    # seeds = [345, 456]   # можно расширить список
    # seeds = [567, 678]   # можно расширить список
    seeds = [789, 890]   # можно расширить список
    # seeds = [901, 1012]   # можно расширить список
    # seeds = [1012]   # можно расширить список
