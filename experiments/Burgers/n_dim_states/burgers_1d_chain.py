...
TARGET_PROJECT_NAME = "rlpinn_burgers_1d_rebuild_buffer_3_dim"
DEFAULT_SOURCE_PROJECT_NAME = "rlpinn-burgers1d-tolerance-corrected"
path_to_trans = os.path.join("transitions_rebuilt", "burgers_1d")
...
def main():
    ...
    parser.add_argument("--name", type=str, default="burgers1d_rebuild")
    ...
    experiment.log_parameters({
        ...
        "reward_function": "v_2",
        "description": (
            "rebuild_burgers_1d_buffer"
            if args.rebuild_buffer_only
            else "optimization_burgers_1d_rl_optimizer"
        ),
