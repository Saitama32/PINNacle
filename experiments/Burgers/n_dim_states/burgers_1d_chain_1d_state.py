...
TARGET_PROJECT_NAME = "rlpinn_burgers_1d_rebuild_buffer_1_dim"
DEFAULT_SOURCE_PROJECT_NAME = "rlpinn-burgers1d-tolerance-corrected"
LOCAL_OUTPUT_DIR = os.path.join("transitions_rebuilt", "burgers_1d_1_dim")
...
def main():
    ...
    parser.add_argument("--name", type=str, default="burgers1d_1d_state_rebuild")
    ...
    experiment.log_parameters({
        ...
        "reward_function": "v_2",
        "description": (
            "rebuild_burgers_1d_buffer_1d_state"
            if args.rebuild_buffer_only
            else "optimization_burgers_1d_rl_optimizer_1d_state"
        ),
