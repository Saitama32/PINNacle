...
TARGET_PROJECT_NAME = "rlpinn_ks_rebuild_buffer_1_dim"
DEFAULT_SOURCE_PROJECT_NAME = "rlpinn-kuramoto-sivashinsky-tolerance"
LOCAL_OUTPUT_DIR = os.path.join("transitions_rebuilt", "kuramoto_sivashinsky_1_dim")
...
def main():
    ...
    parser.add_argument("--name", type=str, default="kuramoto_sivashinsky_1d_state_rebuild")
    ...
    experiment.log_parameters({
        ...
        "reward_function": "v_2",
        "description": (
            "rebuild_kuramoto_sivashinsky_buffer_1d_state"
            if args.rebuild_buffer_only
            else "optimization_kuramoto_sivashinsky_rl_optimizer_1d_state"
        ),
