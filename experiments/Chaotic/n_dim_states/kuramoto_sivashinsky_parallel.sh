#!/bin/bash
# Rebuild Kuramoto-Sivashinsky buffers from two source experiments and distribute jobs across GPUs.

SCRIPT="experiments/Chaotic/n_dim_states/kuramoto_sivashinsky_chain.py"
