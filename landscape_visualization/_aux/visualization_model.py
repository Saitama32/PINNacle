...
class VisualizationModel:
    ...
    def train(self,
        ...
        self.optimizer = torch.optim.RMSprop(self.AE_model.parameters(), lr=lr)

        scheduler = CosineAnnealingWarmRestarts(self.optimizer, cosine_scheduler_patience)
