...
from landscape_visualization._aux.PINN_loss_data import PINNLossData, extract_layers_from_dde_fnn, get_PINN
...
class PlotLossSurface:
    ...
    def __init__(self,
        ...
        self.dde_pde_model.compile(torch.optim.Adam(self.dde_pde_model.net.parameters(), lr=0.001), loss_weights=loss_weights)
        self.states_dict = {}
        self.counter = 1

        self.PINN_layers = extract_layers_from_dde_fnn(self.dde_pde_model.net)
    ...
    def compute_losses(self, models):
        """Get losses for list of models (DeepXDE version, structure preserved)"""
        ...
        for i in range(models.shape[0]):
            ...
            new_model = copy.deepcopy(self.dde_pde_model.net)
    ...
    def get_coordinates_and_losses_of_trajectories(self):
    ...
    def get_coordinates_and_losses_of_surface(self):
        ...
        # Scan the latent grid, then decode each coordinate and evaluate the PDE loss.
    ...
    def save_equation_loss_surface(self, log_key: bool = False):
