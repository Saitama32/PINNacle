...
def run_deepxde_rl_training(
    ...
    rl_agent.replay_buffer = collect_all_comet_transitions(rl_agent.replay_buffer, max_exps_last=rl_agent_params.get("max_exps_last", 200), tolerance = rl_agent_params["tolerance"],
