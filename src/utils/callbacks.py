    ...
    def on_epoch_end(self):
        ...
        if self.verbose:
            ...
            print(
                ...
                f"periodic={values['periodic_loss']:.10e} "
                f"periodic_weight={values['periodic_weight']:.10e} "
                f"weighted_periodic={values['weighted_periodic_loss']:.10e} "
